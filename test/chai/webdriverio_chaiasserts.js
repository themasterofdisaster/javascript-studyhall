/*
    UPDATE EXISTING PROJECT ASSERTIONS TO CHAI ASSERTIONS

    This is a Mohca + WebdriverIO test example to which we've updated the mocha assertions to be chai assertions. 
